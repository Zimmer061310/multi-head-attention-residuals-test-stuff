...
Usage (single 8xH100 node, FSDP full-shard):
    torchrun --nproc_per_node=8 train_cpt.py --fsdp \
...
def build_model(args, device):
    ...
    if args.attnres_mode:
        ...
        _sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                         "Attention-Residuals"))
        import modeling_llama_attnres as _M
        from modeling_llama_attnres import LlamaAttnResConfig, LlamaAttnResForCausalLM
