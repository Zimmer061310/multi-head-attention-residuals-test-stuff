...
MHAR_OUTPUT_DIR="${MHAR_OUTPUT_DIR:-/root/autodl-tmp/experiment1/checkpoint-1b-h4-fineweb-edu}"
...
exec "$MHAR_PYTHON_BIN" -m torch.distributed.run \
  ...
  --wandb_group mhar-exp1-1b-h4-fineweb-edu \
  --wandb_required \
  --run_name mhar-exp1-1b-h4-fineweb-edu-seed42 \
  "${MHAR_RESUME_ARGS[@]}"
