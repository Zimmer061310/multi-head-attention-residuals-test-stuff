...
Usage (on a GPU node):
    python3 test_mhar_fused.py            # correctness
    python3 test_mhar_fused.py --bench    # + routing-chain microbenchmark
"""
...
import mhar_triton
from modeling_qwen3_attnres import mh_block_attn_res, enable_compile
